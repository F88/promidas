...
- **`protopedia-api-v2-client` (peer dependency)**: update deliberately and keep the supported range accurate.
...
- **ESLint**: stays on the `9.x` line for now; `10.x` is deferred.
