...
1. **Dependency Injection:** All tests construct `ProtopediaInMemoryRepositoryImpl` directly with injected dependencies (never use `createProtopediaInMemoryRepository` factory in these tests)
